...
1. Create a new GitHub repository. Give your repository a descriptive title that reflects your analysis (not "`EDS223-HW4`"). Be sure to include a README that follows these [guidelines](https://ucsb-meds.github.io/README-guidelines/). 
