...
description: "Creating a professional GitHub presence"
author: "Ruth Oliver"
date: last-modified
execute: 
  eval: false
...
- A `README`
  - Contents should follow the [guidance from EDS 296](https://ucsb-meds.github.io/README-guidelines/#repository-level-readmes)
...
- Your revised homework assignment, as a rendered Quarto document (both `.qmd` and `.html` files). Include the  following updates:
  ...
  - Double check that all contents meet the [standard of professional output](https://eds-223-geospatial.github.io/assignments.html#rubric)
  - Any other updates you want to make! Including [updating the theme](https://quarto.org/docs/output-formats/html-themes.html#theme-options)
...
Please submit your PR to [this Google Form](https://forms.gle/sSXfA8CvodbNFkRt7).
