...
For far too long, environmental inequities have been invisible, and thus ignored. Mapping environmental inequities can be a powerful tool for revealing injustices. We will be working with data from the United States Environmental Protection Agency's previous [EJScreen: Environmental Justice Screening and Mapping Tool](https://www.epa.gov/ejscreen).
...
While this tool is no longer available, an unofficial version of the tool can be found [here](https://pedp-ejscreen.azurewebsites.net/). 
...
- [ ] Your github repository contains a README that follows the [MEDS README guidelines](https://ucsb-meds.github.io/README-guidelines/), and you added your repo link to this [sheet](https://drive.google.com/file/d/14CauXFZkVh_6z2Euq0m1Sq1kHQ31fiMk/view?usp=sharing)
