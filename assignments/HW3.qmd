...
1. Create a new GitHub repository. Give your repository a descriptive title that reflects your analysis (not "`EDS223-HW3`"). Be sure to include a README that follows these [guidelines](https://ucsb-meds.github.io/README-guidelines/). 
...
4. Add the data to your `gitignore`! Run `git add .gitignore` to avoid attempting to push any large data to your repo. 
5. Create a Quarto document with responses
6. Take a screenshot of your README and add it to the beginning of your qmd. 
7. Render your quarto document as a pdf and submit on [Gradescope](https://www.gradescope.com/courses/1133964)
      - [ ] Make sure code-fold is **not** set to `True`! Your pdf should contain all your code and outputs! 
8. Once you have fully completed this assignment(including revising and resubmitting), make sure to delete the image of the README from your .qmd file. The image of your README is solely being used for grading purposes. 
...
- [ ] Your GitHub repository is clean and well organized. It should contain a README that follows the [MEDS README guidelines](https://ucsb-meds.github.io/README-guidelines/). 
