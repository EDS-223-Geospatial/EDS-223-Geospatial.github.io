...
attr_layers_df = tibble::tribble(
  ...
  "st_intersects()", "draws coordinate grid lines of the coordinate system of the main shape object",
  "st_touches()", "draws latitude and longitude graticules", 
  "st_overlaps()", "adds a scale bar", 
  "st_contains()", "adds a compass rose", 
  "st_contains_properly()", "adds a text annotation", 
  "st_covers()", "adds a logo",
  "st_covered_by()", "adds an x axis labels", 
  "st_within()", "adds an y axis labels",
  "st_disjoint()", "adds minimap in the view mode only",
  "st_is_within_distance()", "adds minimap in the view mode only",
  "st_join()", "adds minimap in the view mode only",
  "st_interpolate_aw()", "adds minimap in the view mode only",
  "aggregate()", "adds minimap in the view mode only",
  "st_union()", "adds minimap in the view mode only",
  "st_buffer()", "adds minimap in the view mode only",
  "st_intersection()", "adds minimap in the view mode only",
  "st_difference()", "adds minimap in the view mode only",
  "st_sym_difference()", "adds minimap in the view mode only",
  "st_centroid()", " ",
  "st_simplify()", "adds minimap in the view mode only"
)
