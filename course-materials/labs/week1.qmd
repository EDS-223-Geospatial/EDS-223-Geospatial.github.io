...
world_elevation <- read_stars(here("course-materials","labs","data","worldelevation.tif"))

# country boundaries
world_vector <- read_sf(here("course-materials","labs","data","worldvector.gpkg"))

# major cities
world_cities <- read_sf(here("course-materials","labs","data","worldcities.gpkg"))
