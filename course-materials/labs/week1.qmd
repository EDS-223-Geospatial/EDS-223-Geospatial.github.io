...
- Download the [week 1 materials](https://downgit.github.io/#/home?url=https://github.com/EDS-223-Geospatial/Weekly-Labs/tree/main/week1) needed for our lab. Upload this folder to your EDS 223 repository, in your Week 1 folder. 

- Navigate to the `tmap_intro.qmd`file. Follow along with the in class lab and fill out this qmd as you go! 
...
world_elevation <- read_stars(here::here("course-materials","data", "week1","worldelevation.tif"))
...
How would I update the legend to be on the right side of my plot instead of beneath? If you aren't sure, check the [documentation](https://cran.r-project.org/web/packages/tmap/tmap.pdf)!
...
Similar to the `theme()` function in `ggplot2`, you can control many of the map elements of the map layout.Play around with some of the different `tm_layout` options by checking the [documentation](https://cran.r-project.org/web/packages/tmap/tmap.pdf).
