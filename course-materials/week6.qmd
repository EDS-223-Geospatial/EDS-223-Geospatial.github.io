...
| {{< fa laptop-code title="A laptop with on-screen code" >}} Lab                 | [Vector and raster interactions cont.; False color images]()        |
| {{< fa download title="download" >}} Lab materials to download                  | [Vector and raster interactions cont.; False color images](){target="_blank"} |
