...
| {{< fa comments title="two speech bubbles" >}} Discussion               | [Working with false color images](discussions/week6-discussion.qmd){target="_blank"} ([*Answer Key*](discussions/answer-keys/week6-discussion-answerKey.qmd){target="_blank"}) |
