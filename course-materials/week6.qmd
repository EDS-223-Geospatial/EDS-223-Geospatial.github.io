...
| {{< fa laptop-code title="A laptop with on-screen code" >}} Lab                 | [Vector and raster interactions cont.; False color images](labs/week6.qmd){target="_blank"}        |
| {{< fa comments title="two speech bubbles" >}} Discussion               | Working with false color images (*Answer Key*) <!--[Working with false color images](discussions/week6-discussion.qmd){target="_blank"} ([*Answer Key*](discussions/answer-keys/week6-discussion-answerKey.qmd){target="_blank"})--> |
...
|-----------------|-----------------------------------------------|---------------|------------|
| EOC             | [End-of-class survey (week 6)](https://forms.gle/nTf1iao32byVN7ZUA){target="_blank"}              | 11/04/2024    | 11/04/2024 |
