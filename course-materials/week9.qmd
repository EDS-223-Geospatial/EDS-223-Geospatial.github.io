...
| {{< fa laptop-code title="A laptop with on-screen code" >}} Lab                 | [Landcover classification with random forests](labs/week9.qmd) |
| {{< fa comments title="two speech bubbles" >}} Discussion               | No discussion section|
