...
| Session                                                                         | Materials                                             |
|---------------------------------------------------------------------------------|-------------------------------------------------------|
| {{< fa person-chalkboard title="A person motioning at a chalkboard" >}} Lecture | [Intro to basic spatial data and geometry operations with vector data](https://docs.google.com/presentation/d/1iygfMXO3VI11_XJjdq2OomKUbOYosz5pJ1yW87mP-3s/present){target="_blank"}                  |
| {{< fa download title="download" >}} Lab materials to download                  | [Spatial joins, topological relationships, and distance relationships](https://downgit.github.io/#/home?url=https://github.com/EDS-223-Geospatial/Weekly-Labs/tree/main/week3){target="_blank"} |
| {{< fa key title="key" >}} Lab solution                                         | [Spatial joins, topological relationships, and distance relationships](labs/week3.qmd) |
| {{< fa comments title="two speech bubbles" >}} Discussion               | [Practice vector operations](discussions/week3-discussion.qmd) |
...
|-----------------|-----------------------------------------------|---------------|------------|
| Check-In             | [Check-In (week 3)](https://docs.google.com/forms/d/e/1FAIpQLScJ_TcH0PqOcFUtUY9CGiznjW2CgZEximTKMOCrq7LDwTVblA/viewform?usp=header){target="_blank"}              | 10/16/2025    | 10/16/2025 |
