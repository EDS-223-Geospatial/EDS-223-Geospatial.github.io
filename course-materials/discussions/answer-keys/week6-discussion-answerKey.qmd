...
# Set directory for folder
pre_fire_dir <- here::here("course-materials", "data", "week6-discussion", "LC80340322016189-SC20170128091153")
...
# Read mask raster
pre_mask <- rast(here::here("course-materials", "data", "week6-discussion", "LC80340322016189-SC20170128091153", "LC80340322016189LGN00_cfmask_crop.tif"))
```
...
# Set directory for folder
post_fire_dir <- here::here("course-materials", "data", "week6-discussion", "LC80340322016205-SC20170127160728")
...
# Read mask raster
post_mask <- rast(here::here("course-materials", "data", "week6-discussion", "LC80340322016205-SC20170127160728", "LC80340322016205LGN00_cfmask_crop.tif"))
```
