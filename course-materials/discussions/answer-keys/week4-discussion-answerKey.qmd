...
```{r}
hist(dem,
     main = "Digital Elevation Model Value Distribution",
     xlab = "Value")
...
rcl <- matrix(c(-Inf, 300, 0, # values -Inf to 300 become 0
                300, 500, 1,  # values 300 to 500 become 1
                500, Inf, 2), # values 500 to Inf become 2
              ncol = 3, byrow = TRUE)

# apply the matrix to reclassify the raster
