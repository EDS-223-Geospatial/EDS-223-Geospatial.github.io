...
4. Find the distance across all cells in `peru_dem` to its nearest coastline
  ...
  - Weigh the distance raster with `peru_dem` and visualize the difference between the raster created using the Euclidean distance (E7) and the raster weighted by elevation
