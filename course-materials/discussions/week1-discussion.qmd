...
Next, let's [download some data from Rapa Nui](https://drive.google.com/drive/folders/1zoHTlNZZN7qrGIA7kIUtFZvDC6FJ8ggb). Unzip and move this to your version-controlled R Project's `data` folder. 
